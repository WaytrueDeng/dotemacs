...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "telega-filter" '("all" "any" "archive" "can-get-statistics" "chat-list" "contact" "custom" "default-disable-notification" "define-telega-filter" "folder" "has-" "ids" "inactive-supergroups" "last-message-by-me" "main" "name" "nearby" "not" "online-status" "permission" "pin" "restriction" "saved-messages" "search" "telega-" "top" "tracking" "type" "unmuted" "unread" "verified")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "telega-tdlib-events" '("telega-" "tracking-buffers")))
